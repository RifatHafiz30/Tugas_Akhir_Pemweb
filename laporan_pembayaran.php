...
<table width="100%">
	...
	<a  href="#" onclick="window.print();"><button id="button1" class="btn btn-danger btn-lg">Export to PDF</button></a>
	<a  href="excel_laporan_pembayaran.php?tgl1= <?= $_GET['tgl1']; ?> & tgl2= <?= $_GET['tgl2']; ?>" class="hidden-print"><button id="button2" class="btn btn-success btn-lg">Export to Excel</button></a>
